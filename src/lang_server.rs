...
use tokio::{io::AsyncWriteExt, process::{Child, ChildStdin, Command}, sync::Mutex};
...
pub async fn to_lsp(req: HttpRequest, stream: web::Payload, process: web::Data<Arc<std::sync::Mutex<Child>>>) -> Result<HttpResponse, Error> {
